...
// moved
  ...
  test('text superscript', function() {
    ...
    equal(text.styles[0][1].fontSize, size * schema.size, 'character 1: fontSize has been set');
    equal(text.styles[0][1].deltaY, size * schema.baseline, 'character 1: deltaY has been set');

    equal(text.styles[0][2].fontSize, styleFontSize * schema.size, 'character 2: fontSize has been decreased');
    equal(text.styles[0][2].deltaY, styleDeltaY + styleFontSize * schema.baseline, 'character 2: deltaY has been decreased');
  });
  ...
  test('text subscript', function() {
    ...
    equal(text.styles[0][2].fontSize, styleFontSize * schema.size, 'character 2: fontSize has been decreased');
    equal(text.styles[0][2].deltaY, styleDeltaY + styleFontSize * schema.baseline, 'character 2: deltaY has been increased');
  });
